...
- document single-thread requirement for `Storage`'s sqlite3 connection (`README.md`)
- changed project status from "not yet production-ready" to reflect Beta (`README.md`)

## [0.3.1] - 2026-08-26

### Added

- add basic logging (`cli.py`, `mailer.py`)
